...
export const appRoutes: Route[] = [
...

    {
        ...
        children: [
            ...
            {path: 'confirm-email/:token', loadChildren: () => import('app/modules/auth/confirm-email/confirm-email.routes')},
        ]
    },
    ...
    // Admin routes
    {
        ...
        children: [
            ...
            {path: 'dashboards', children: [
                {path: 'sme', loadChildren: () => import('app/modules/admin/dashboards/project/project.routes')},
                {path: 'institution', loadChildren: () => import('app/modules/admin/dashboards/analytics/analytics.routes')},
